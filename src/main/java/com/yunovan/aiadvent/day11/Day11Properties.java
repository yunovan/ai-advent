...
@ConfigurationProperties(prefix = "day11")
public record Day11Properties(
        Long contextLimit,
    ...
    public static final String DEFAULT_DIALOG_DIR = "data/day11-dialogs";
    public static final String DEFAULT_MEMORY_DIR = "data/day11-memory";
    public static final int DEFAULT_SHORT_TERM_WINDOW = 10;

    public Day11Properties {
